...
public class CameraController : MonoBehaviourPun
{
    ...
    private void Update()
    {
        ...
        if (lockTarget != null)
        {
            ...
            //Debug.Log(lockTarget.obj.name);
            //ActorManager targetAm = lockTarget.obj.GetComponent<ActorManager>();
            //Debug.Log(lockTarget.am + "&&" + lockTarget.am.sm);
            if (lockTarget != null && lockTarget.am != null 
                && lockTarget.am.sm!= null && lockTarget.am.sm.isDie)
            {
                LockProcessA(null, false, false, isAI);
            }
        }
