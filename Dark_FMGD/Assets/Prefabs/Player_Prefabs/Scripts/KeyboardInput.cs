...
public class KeyboardInput : IUserInput
{
    ...
    public string btnChangeWeapon = "r";
    public string btnChangeSide = "y";
    public string btnOneOrTwoHands = "g";
    ...
    public MyButton buttonChangeWeapon = new MyButton();
    public MyButton buttonChangeSide = new MyButton();
    public MyButton buttonOneOrTwoHands = new MyButton();
    ...
    void Update()
    {
        ...
        buttonChangeWeapon.Tick(Input.GetKey(btnChangeWeapon));
        buttonChangeSide.Tick(Input.GetKey(btnChangeSide));
        buttonOneOrTwoHands.Tick(Input.GetKey(btnOneOrTwoHands));
        ...
        changeWeapon = buttonChangeWeapon.OnPressed;
        changeSide = buttonChangeSide.OnPressed;
        changeOneRoTwo = buttonOneOrTwoHands.OnPressed;
    }
